<template>
    ...
    <div class="">
      ...
      <div class="space-y-4">
        ...
        <p>
          ...
          fact is that I get a huge moral satisfaction, when I create or improve
          something with my own hands.
        </p>
        <p>
          And in programming the results of your actions can be seen instantly.
          I like it a lot.
        </p>
      </div>
    </div>
  ...
  <router-link
    :to="{ name: 'Projects' }"
    class="p-3 rounded bg-gray-900 hover:bg-gray-800 transition duration-300 inline-block my-5"
